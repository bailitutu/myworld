        ...
        function() {
            return function(e) {
                        ...
                        function(n, o) {
                            o = function(e, t, n) {
                                function i(a, o, r) {
                                    ...
                                    a && r.push.apply(r, a[t] ? [a] : "" + a === a ? /</.test(a) ? ((o = e.createElement(o || t)).innerHTML = a, o.children) : o ? (o = i(o)[0]) ? o[n](a) : r: e[n](a) : "function" == typeof a ? e.readyState[7] ? a() : e[t]("DOMContentLoaded", a) : a),
                                        r
                                }
                                return i.fn = [],
                                    i.one = function(e, t) {
                ...
                function(e, t, n) {
                    ...
                    function a() {
                        ...
                        return (0, r.
                            ...
                            n.addClass("weui-animate-fade-in"),
                            setTimeout(function() {
                ...
                function(e, t, n) {
                    ...
                    function a() {
                        function e() {
                            u.addClass(a ? "weui-animate-fade-out": "weui-animate-slide-down"),
                        ...
                        return (0, r.
                            ...
                            r.
                            default.getStyle(u[0], "transform"),
                            u.addClass(a ? "weui-animate-fade-in": "weui-animate-slide-up"),
                            f.addClass("weui-animate-fade-in").on("click", e),
                            o.find(".weui-actionsheet__menu").on("click", ".weui-actionsheet__cell",
                                function(n) {
                                    var i = (0, r.
                                        default)(this).index();
                                    t[i].onClick.call(this, n),
                                        e()
                                }),
                            o.find(".weui-actionsheet__action").on("click", ".weui-actionsheet__cell",
                                function(t) {
                                    var i = (0, r.
                                        default)(this).index();
                                    n[i].onClick.call(this, t),
                                        e()
                                }),
                            d = o[0],
                            d.hide = e,
                ...
                function(e, t, n) {
                    ...
                    function a(e) {
                        ...
                        d && (clearTimeout(d.timeout), d.hide()),
                            ...
                            d.timeout = setTimeout(t, n.duration),
                            i[0].hide = t,
                            i[0]
                    }
                    Object.defineProperty(t, "__esModule", {
                ...
                function(e, t, n) {
                    ...
                    function a(e, t) {
                        ...
                        t.onError && !
                            ...
                            o.find('input[type="file"]').on("change",
                                function(e) {
                                    ...
                                    0 !== n.length && (t.compress === !1 && "file" == t.type ? Array.prototype.forEach.call(n,
                                        ...
                                        function(e) {
                                            e.id = ++c,
                                            t.onBeforeQueued(e, n) !== !1 && (0, d.compress)(e, t,
                                                function(e) {
                                                    e && a(e)
                                                })
                                        }), this.value = "")
                ...
                function(e, t) {
                    ...
                    function a(e, t, a) {
                        ...
                        o.onload = function(o) {
                            if (t.compress === !1) return e.base64 = o.target.result,
                                void a(e);
                            var r = new Image;
                            r.onload = function() {
                                var o = n(r),
                                    ...
                                    c = r.height,
                                    p = void 0;
                                if (s < c && c > f ? (s = parseInt(f * r.width / r.height), c = f) : s >= c && s > d && (c = parseInt(d * r.height / r.width), s = d), u.width = s, u.height = c, l.drawImage(r, 0, 0, s, c / o), p = /image\/jpeg/.test(e.type) || /image\/jpg/.test(e.type) ? u.toDataURL("image/jpeg", t.compress.quality) : u.toDataURL(e.type), "file" == t.type) if (/;base64,null/.test(p) || /;base64,$/.test(p)) a(e);
                                else {
                                    var v = i(p);
                                    v.id = e.id,
                                        v.name = e.name,
                                        v.lastModified = e.lastModified,
                                        v.lastModifiedDate = e.lastModifiedDate,
                                        a(v)
                                } else / ;
                                base64,
                                null / .test(p) || /;base64,$/.test(p) ? (t.onError(e, new Error("Compress fail, dataURL is " + p + ".")), a()) : (e.base64 = p, a(e))
                            },
                    ...
                    function n(e) {
                        ...
                        if (a(n, s, c) !== !1) {
                            ...
                            n.xhr = v,
                                ...
                                "file" == e.type ? p.append(i, n, l) : p.append(i, n.base64),
                ...
                function(e, t, n) {
                    ...
                    function o() {
                        function e(n, i) {
                            ...
                            d.find(".weui-picker__group").eq(i).scroll({
                                ...
                                onChange: function(n, a) {
                                    ...
                                    else if (n.children && n.children.length > 0) d.find(".weui-picker__group").eq(i + 1).show(),
                                    !t && e(n.children, i + 1);
                                    else {
                        ...
                        var a = arguments[arguments.length - 1],
                            ...
                            default.extend({
                                ...
                                a);
                        w[o.id] = w[o.id] || [];
                        for (var r = [], u = w[o.id], d = (0, l.
                            default)(l.
                        default.render(c.
                            default, o)), s = a.depth || (t ? n.length: f.depthOf(n[0])), p = ""; s--;) p += v.
                            default;
                        return d.find(".weui-picker__bd").html(p),
                            _(d),
                            t ? n.forEach(function(t, n) {
                                e(t, n)
                            }) : e(n, 0),
                            d.on("click", ".weui-mask",
                                function() {
                                    y(d)
                    ...
                    var d = n(26),
                        ...
                        _ = function(e) { (0, l.
                            ...
                            l.
                            default.getStyle(e[0], "transform"),
                ...
                function(e, t, n) {
                    ...
                    o.
                        ...
                        var t = this,
                            ...
                            default)(this).find(".weui-picker__content").html(i);
                        var a = (0, o.
                                default)(this).find(n.scrollable),
                            c = void 0,
                            p = void 0,
                            v = void 0,
                            h = void 0,
                        ...
                        if (null !== n.temp && n.temp < n.items.length) {
                            var y = n.temp;
                            n.onChange.call(this, n.items[y], y),
                                h = (n.offset - y) * n.rowHeight
                        } else {
                            var w = l(n.items);
                            n.onChange.call(this, n.items[w], w),
                                h = d(n.offset, n.rowHeight, n.items)
                        }
                        u(a, h);
                        var g = function(e) {
                            h += e,
                                h = Math.round(h / n.rowHeight) * n.rowHeight;
                            ...
                            h = (n.offset - l) * n.rowHeight,
                                r(a, .3),
                                u(a, h),
                                n.onChange.call(t, n.items[l], l)
                        };
                        a = (0, o.
                            default)(this).offAll().on("touchstart",
                            function(e) {
                            ...
                            function(e) {
                                ...
                                if (t - v > 100) g(Math.abs(p - c) > 10 ? p - c: i - p);
                                    ...
                                    for (var a = m.length - 1,
                                             o = a,
                                             r = a; r > 0 && v - m[r].time < 100; r--) o = r;
                                    if (o !== a) {
                                        var u = m[a],
                                            l = m[o],
                                            d = u.time - l.time,
                ...
                function(e, t, n) {
                    ...
                    function a(e) {
                        ...
                        return (0, r.
                            default)("body").append(i),
                            i.find(".weui-gallery__img").on("click", t),
                            i.find(".weui-gallery__del").on("click",
                                function() {
                                    n.onDelete.call(this, e)
                                }),
                            i.show().addClass("weui-animate-fade-in"),
                            d = i[0],
                            d.hide = t,
                            d
                    }
                    ...
                    function a(e) {
                        ...
                        return n.forEach(function(e) {
                            ...
                            var a = (0, r.
                                ...
                                d = parseInt(r.
                                default.getStyle(o[0], "width")),
                                f = o[0].offsetLeft,
                                s = 0,
                                c = 0,
                                p = void 0;
                            t.step && (p = d * t.step / 100),
                            t.defaultValue && i(d * t.defaultValue / 100),
                                a.on("click",
                                    function(e) {
                                        e.preventDefault(),
                                            s = n(),
